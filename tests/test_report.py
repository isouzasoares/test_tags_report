...
DETAIL_PATH_BACKEND = [
    {
        ...
        "it": 1,
        "path": "tests/examples/",
        "tags": ["# #test_example_1::ut", "# #test_example_1_2::it"],
        "tag_names": ["test_example_1::ut", "test_example_1_2::it"],
        "def_names": ["test_example_1", "test_example_1_2"],
        "count_tags": [
            {"count": 1, "name": "test_example_1::ut"},
    ...
    },
    {
        ...
        "it": 1,
        "path": "tests/examples/",
        "tags": ["# #test_example_2::it", "# #test_example_2_2::it"],
        "tag_names": ["test_example_2::it", "test_example_2_2::it"],
        "def_names": ["test_example_2", "test_example_2_2"],
        "count_tags": [
            {"count": 1, "name": "test_example_2::ut"},
...
def test_tag_and_type_backend(backend_instance):
    mock = {
        "original_name": "# #test_get_user_info_with_access::ut",
...
def test_count_tags_path(backend_instance):
    ...
    mock = [
        {"name": "test_get_user_info_with_access", "count": 2},
...
def test_consolidate_data(backend_instance):
    path_data = [
        {"total_defs": 3, "total_tags": 6, "ut": 1, "it": 2, "component": 0},
        {"total_defs": 4, "total_tags": 1, "ut": 0, "it": 3, "component": 2},
    ]
    mock = {
        "total_tags": 7,
        "total_defs": 7,
